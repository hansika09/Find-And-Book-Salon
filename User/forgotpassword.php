...
{
    $email=$_POST['email'];
    $selectquery= mysqli_query($connection, "select * from tbl_user where email='{$email}'") or die(mysqli_error($connection));
...
<button type="submit" class="btn common-btn two">Send Link via Mail</button>
